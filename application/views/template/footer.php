 			...
 			<div class="w3_footer_grids">
 				<div class="col-md-3 w3_footer_grid">
 					...
 					<ul class="address">
 						...
 						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@gadgetstore.com</a></li>
...
<?php if (empty($this->session->userdata('userid'))) { ?>
              ...
              <?php } else{ ?>
              <li><a href="<?=base_url()?>Order/my_account">My Order</a></li>
